...
import 'package:medihelp/ui/widgets/input_field.dart';
...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  String _selectedRepeat = "Only for today";
                    ...
                    children: [
                      Container(
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: Color.fromARGB(179, 121, 119, 119))),
                        //height: 30,
                        //width: 52,
                        child: Padding(
